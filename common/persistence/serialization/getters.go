...
func (w *WorkflowExecutionInfo) GetParentDomainID() (o string) {
	if w != nil && w.ParentDomainID != nil {
...
func (w *WorkflowExecutionInfo) GetParentRunID() (o string) {
	if w != nil && w.ParentRunID != nil {
...
func (c *ChildExecutionInfo) GetStartedRunID() (o string) {
	if c != nil && c.StartedRunID != nil {
...
func (t *TaskInfo) GetRunID() (o string) {
...
func (t *TransferTaskInfo) GetDomainID() (o string) {
...
// GetRunID internal sql blob getter
func (t *TransferTaskInfo) GetRunID() (o string) {
	if t != nil && t.RunID != nil {
		return *t.RunID
	}
	return
...
func (t *TransferTaskInfo) GetTargetDomainID() (o string) {
	if t != nil && t.TargetDomainID != nil {
...
func (t *TransferTaskInfo) GetTargetRunID() (o string) {
	if t != nil && t.TargetRunID != nil {
...
// GetDomainID internal sql blob getter
func (t *TimerTaskInfo) GetDomainID() (o string) {
	if t != nil && t.DomainID != nil {
		return *t.DomainID
	}
	return
...
// GetRunID internal sql blob getter
func (t *TimerTaskInfo) GetRunID() (o string) {
	if t != nil && t.RunID != nil {
		return *t.RunID
	}
	return
...
// GetDomainID internal sql blob getter
func (t *ReplicationTaskInfo) GetDomainID() (o string) {
	if t != nil && t.DomainID != nil {
		return *t.DomainID
	}
	return
...
// GetRunID internal sql blob getter
func (t *ReplicationTaskInfo) GetRunID() (o string) {
	if t != nil && t.RunID != nil {
		return *t.RunID
	}
	return
