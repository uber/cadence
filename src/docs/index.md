...
The Cadence solution is a [_fault-oblivious stateful_ programming model](concepts/workflows/) that obscures most of the complexities of building scalable distributed applications. In essence, Cadence provides a durable virtual memory that is not
