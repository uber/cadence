...
type TChanMatchingService interface {
	...
	PollForActivityTask(ctx thrift.Context, pollRequest *PollForActivityTaskWrappedRequest) (*shared.PollForActivityTaskResponse, error)
	PollForDecisionTask(ctx thrift.Context, pollRequest *PollForDecisionTaskWrappedRequest) (*shared.PollForDecisionTaskResponse, error)
}
...
func (c *tchanMatchingServiceClient) PollForActivityTask(ctx thrift.Context, pollRequest *PollForActivityTaskWrappedRequest) (*shared.PollForActivityTaskResponse, error) {
...
func (c *tchanMatchingServiceClient) PollForDecisionTask(ctx thrift.Context, pollRequest *PollForDecisionTaskWrappedRequest) (*shared.PollForDecisionTaskResponse, error) {
