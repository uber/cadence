...
type TChanHistoryService interface {
	GetWorkflowExecutionHistory(ctx thrift.Context, getRequest *GetWorkflowExecutionHistoryWrappedRequest) (*shared.GetWorkflowExecutionHistoryResponse, error)
	RecordActivityTaskHeartbeat(ctx thrift.Context, heartbeatRequest *RecordActivityTaskHeartbeatWrappedRequest) (*shared.RecordActivityTaskHeartbeatResponse, error)
	...
	RespondActivityTaskCanceled(ctx thrift.Context, canceledRequest *RespondActivityTaskCanceledWrappedRequest) error
	RespondActivityTaskCompleted(ctx thrift.Context, completeRequest *RespondActivityTaskCompletedWrappedRequest) error
	RespondActivityTaskFailed(ctx thrift.Context, failRequest *RespondActivityTaskFailedWrappedRequest) error
	RespondDecisionTaskCompleted(ctx thrift.Context, completeRequest *RespondDecisionTaskCompletedWrappedRequest) error
	StartWorkflowExecution(ctx thrift.Context, startRequest *StartWorkflowExecutionWrappedRequest) (*shared.StartWorkflowExecutionResponse, error)
}
...
func (c *tchanHistoryServiceClient) GetWorkflowExecutionHistory(ctx thrift.Context, getRequest *GetWorkflowExecutionHistoryWrappedRequest) (*shared.GetWorkflowExecutionHistoryResponse, error) {
...
func (c *tchanHistoryServiceClient) RecordActivityTaskHeartbeat(ctx thrift.Context, heartbeatRequest *RecordActivityTaskHeartbeatWrappedRequest) (*shared.RecordActivityTaskHeartbeatResponse, error) {
...
func (c *tchanHistoryServiceClient) RespondActivityTaskCanceled(ctx thrift.Context, canceledRequest *RespondActivityTaskCanceledWrappedRequest) error {
...
func (c *tchanHistoryServiceClient) RespondActivityTaskCompleted(ctx thrift.Context, completeRequest *RespondActivityTaskCompletedWrappedRequest) error {
...
func (c *tchanHistoryServiceClient) RespondActivityTaskFailed(ctx thrift.Context, failRequest *RespondActivityTaskFailedWrappedRequest) error {
...
func (c *tchanHistoryServiceClient) RespondDecisionTaskCompleted(ctx thrift.Context, completeRequest *RespondDecisionTaskCompletedWrappedRequest) error {
...
func (c *tchanHistoryServiceClient) StartWorkflowExecution(ctx thrift.Context, startRequest *StartWorkflowExecutionWrappedRequest) (*shared.StartWorkflowExecutionResponse, error) {
