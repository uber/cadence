...
var HistoryService_RespondActivityTaskCanceled_Helper = struct {
	Args           func(canceledRequest *RespondActivityTaskCanceledRequest) *HistoryService_RespondActivityTaskCanceled_Args
...
func init() {
	HistoryService_RespondActivityTaskCanceled_Helper.Args = func(canceledRequest *RespondActivityTaskCanceledRequest) *HistoryService_RespondActivityTaskCanceled_Args {
		return &HistoryService_RespondActivityTaskCanceled_Args{CanceledRequest: canceledRequest}
	}
